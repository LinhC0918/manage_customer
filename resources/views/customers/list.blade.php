...
@section('content')
    <div class="col-12">
        <div class="row">
            <div class="col-12">
                <h1>@lang('language.customerList')</h1>
            </div>
            <div class="col-12">
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <form class="navbar-form navbar-left" action="{{ route('customers.search') }}" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <button type="submit" class="btn btn-default">{!! __('language.search') !!}</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">{!! __('language.city') !!}</th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-6">
                        <a class="btn btn-primary" href="{{ route('customers.create') }}">{!! __('language.create') !!}</a>

                        <a class="btn btn-primary" href="{{ route('customers.export') }}">Export</a>
